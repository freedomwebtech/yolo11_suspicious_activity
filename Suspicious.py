...
frame_total = 10
i = 0
a = 526 # Start from 848 forcefully

all_data = []

# Define output path for cropped images
output_path_dir = r'C:\Users\freed\Downloads\pose\images1'
...
while cap.isOpened():
    ...
    pa = r'C:\Users\freed\Downloads\pose\images'
...
csv_file_path = r'C:\Users\freed\Downloads\pose\nkeypoint.csv'

...
df = pd.read_csv(r'C:\Users\freed\Downloads\pose\dataset_path\dataset_pathdataset.csv')
...
model.save_model(r"C:\Users\freed\Downloads\pose\dataset_path\trained_model.json")
